...
namespace WinAppDriver.Server.CommandHandlers
{
    ...
    {
        public Task<Response> ExecuteAsync(CommandEnvironment environment, Dictionary<string, object> parameters)
        {
        ...
        protected virtual Task<Response> GetResponseAsync(AutomationElement automationElement, CommandEnvironment environment, Dictionary<string, object> parameters)
        {
            ...
            {
                return TryGetResponse(automationElement, environment, parameters);
            }, environment.GetCancellationToken());
        }
    }
}
